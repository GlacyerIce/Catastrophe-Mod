 ...
 *
 */
package net.mcreator.catastropheredo;
...
@Mod("catastropheredo")
public class CatastropheredoMod {
	public static final Logger LOGGER = LogManager.getLogger(CatastropheredoMod.class);
	public static final String MODID = "catastropheredo";
