...
public class SteelOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("catastropheredo:steel_ore", FEATURE,
				new OreConfiguration(SteelOreFeatureRuleTest.INSTANCE, CatastropheredoModBlocks.STEEL_ORE.get().defaultBlockState(), 16));
		PLACED_FEATURE = PlacementUtils.register("catastropheredo:steel_ore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(10), InSquarePlacement.spread(),
						HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(39)), BiomeFilter.biome()));
		return FEATURE;
	}
	...
	private static class SteelOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("catastropheredo:steel_ore_match"), CUSTOM_MATCH);
		}
		...
		public boolean test(BlockState blockAt, Random random) {
			if (base_blocks == null) {
				base_blocks = List.of(Blocks.STONE, Blocks.DIORITE, Blocks.GRANITE, Blocks.ANDESITE);
			}
