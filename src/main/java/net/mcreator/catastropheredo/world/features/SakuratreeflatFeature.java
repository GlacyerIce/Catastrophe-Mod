...
public class SakuratreeflatFeature extends Feature<NoneFeatureConfiguration> {
	public static SakuratreeflatFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new SakuratreeflatFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("catastropheredo:sakuratreeflat", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("catastropheredo:sakuratreeflat", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
