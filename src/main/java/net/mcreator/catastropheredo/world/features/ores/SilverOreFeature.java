...
public class SilverOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("catastropheredo:silver_ore", FEATURE,
				new OreConfiguration(SilverOreFeatureRuleTest.INSTANCE, CatastropheredoModBlocks.SILVER_ORE.get().defaultBlockState(), 4));
		PLACED_FEATURE = PlacementUtils.register("catastropheredo:silver_ore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(1), InSquarePlacement.spread(),
						HeightRangePlacement.uniform(VerticalAnchor.absolute(20), VerticalAnchor.absolute(30)), BiomeFilter.biome()));
		return FEATURE;
	}
	...
	private static class SilverOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("catastropheredo:silver_ore_match"), CUSTOM_MATCH);
		}
