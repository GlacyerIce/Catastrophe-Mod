...
public abstract class SakuraDiamondArmorItem extends ArmorItem {
	public SakuraDiamondArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends SakuraDiamondArmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent("This Helmet Seems To be Infused With A Strange Power"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "catastropheredo:textures/models/armor/sakura_diamond__layer_1.png";
		}
	}
	...
	public static class Chestplate extends SakuraDiamondArmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("This Chestplate Seems To Be Infused With A Strange Power"));
		}
	...
	public static class Leggings extends SakuraDiamondArmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("These Leggings Seem To Be Infused With A Strange Power"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "catastropheredo:textures/models/armor/sakura_diamond__layer_2.png";
		}
	}
	...
	public static class Boots extends SakuraDiamondArmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("These Boots Seem To Be Infused With A Strange Power"));
		}
