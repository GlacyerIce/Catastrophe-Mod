...
public class CatastropheredoModEntities {
	...
	public static final EntityType<GappleCowEntity> GAPPLE_COW = register("gapple_cow",
			EntityType.Builder.<GappleCowEntity>of(GappleCowEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true)
					.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(GappleCowEntity::new).sized(0.9f, 1.4f));
	...
	public static void registerAttributes(EntityAttributeCreationEvent event) {
		event.put(GAPPLE_COW, GappleCowEntity.createAttributes().build());
	}
}
